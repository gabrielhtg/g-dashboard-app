...
export class GOcrBankComponent {
  ...
  setSelectedData(index: number): void {
    ...
    this.angularCropper.cropper.setCropBoxData(this.dataBankStatement[index].cropData)
    this.angularCropper.cropper.setCanvasData(this.dataBankStatement[index].canvasData)
  }
  ...
  setSelectedDataTable(index1: number, index2: number): void {
    ...
    this.angularCropper.cropper.setCropBoxData(this.dataTransaksi[index1][index2].cropData)
    this.angularCropper.cropper.setCanvasData(this.dataTransaksi[index1][index2].canvasData)
  }
